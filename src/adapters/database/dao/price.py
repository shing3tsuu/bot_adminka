...
class PriceDAO(AbstractPriceDAO):
    ...
    async def add_price(self, name: str, price: int) -> PriceDTO:
        try:
            ...
            self._logger.error(f"Database error in add_price: {e}")
            raise
    ...
    async def get_price(self, name: str) -> PriceDTO | None:
        try:
            ...
            self._logger.error(f"Database error in get_price: {e}")
            return None
    ...
    async def change_price(self, name: str, price: int) -> PriceDTO:
        try:
            ...
            self._logger.error(f"Database error in change_price: {e}")
            return None