...
dialog = Dialog(
    ...
    Window(
        Format("❌ Ограничение публикации:\n\n{limit_reason}\n\nВыберите другой вариант:"),
        Group(
            Button(Const("🕐 Запланировать публикацию"), id="schedule_post_after_limit", on_click=on_event.on_schedule_post),
            Button(Const("❌ Отменить"), id="cancel_post", on_click=on_event.back_to_main),
        ),
